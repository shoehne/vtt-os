...
/*----
Declare the Multiboot header to mark this code as a kernel with the .section directive. 
The long/doubleword values are
all magic numbers documented in the Multiboot Standard. The bootloader (e.g. GRUB) will 
search for this signature in the first 8 KiB of a kernel file. It is aligned at a 4-byte/32-bit
boundary (the next byte allocation in memory divisible by 4).
----*/
.section .multiboot
.align 4
.long MAGIC
...
64-bit and esp on32-bit systems).
